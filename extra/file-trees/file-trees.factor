...
io.pathnames kernel locals make models.combinators
models.filter sequences strings
ui.gadgets.tables.multi vectors ui.gadgets.tables.renderers ;
IN: file-trees
...
: go-to-path ( path tree -- tree' ) over empty? [ nip ]
   [ [ unclip-slice ] [ children>> ] bi* swap [ swap node>> = ] curry find nip go-to-path ] if ;
...
: <dir-table> ( tree-model -- table )
   f <quot-renderer> [ node>> 1array ] >>quot <table>
