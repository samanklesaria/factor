...
[ { 100 100 } ] [
    vertical <track>
        <gadget> { 100 100 } >>dim 1 add-gadget*
    pref-dim    
] unit-test

[ { 100 110 } ] [
    vertical <track>
        <gadget> { 10 10 } >>dim f add-gadget*
        <gadget> { 100 100 } >>dim 1 add-gadget*
    pref-dim
] unit-test
...
[ { 10 10 } ] [
    vertical <track>
        <gadget> { 10 10 } >>dim 1 add-gadget*
        <gadget> { 10 10 } >>dim 0 add-gadget*
    pref-dim
] unit-test
...
[ ] [
    vertical <track>
        0 >>fill
        <gadget> { 10 10 } >>dim f add-gadget*
        <gadget> { 10 10 } >>dim dup "g1" set 1/2 add-gadget*
        <gadget> { 10 10 } >>dim dup "g2" set f add-gadget*
        <gadget> { 10 10 } >>dim 1/2 add-gadget*
        <gadget> { 10 10 } >>dim f add-gadget*
    { 10 100 } >>dim
    "track" set
] unit-test
